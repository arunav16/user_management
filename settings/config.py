...
class Settings(BaseSettings):
    ...
    smtp_server: str = Field(..., env="smtp_server", description="SMTP server for sending emails")
    smtp_port: int = Field(..., env="smtp_port", description="SMTP port for sending emails")
    smtp_username: str = Field(..., env="smtp_username", description="Username for SMTP server")
    smtp_password: str = Field(..., env="smtp_password", description="Password for SMTP server")
